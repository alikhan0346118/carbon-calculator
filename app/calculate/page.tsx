...
function CarbonFootprintCalculator() {
  ...
  const handleGeneratePDF = async () => {
    ...
    const accentColor = [34, 197, 94]; // #22c55e (green)
    ...
    const addPageHeader = (pageNumber: number) => {
      ...
      doc.text("AI Geo Navigators", 20, 20);

      // Add subtitle
      doc.setFontSize(10);
      doc.setFont("helvetica", "normal");
      doc.setTextColor(lightGray[0], lightGray[1], lightGray[2]);
      doc.text("Carbon Intelligence & Sustainability Solutions", 20, 28);

      // Add page number
      doc.setFontSize(8);
      doc.setFont("helvetica", "normal");
      doc.setTextColor(107, 114, 128);
      doc.text(`Page ${pageNumber}`, 170, 20);
    ...
    const addPageFooter = () => {
      ...
      doc.setFont("helvetica", "normal");
      doc.setTextColor(107, 114, 128);
      doc.text('Generated by AI Geo Navigators - Carbon Intelligence Platform', 20, 280);
    };
    ...
    doc.setFont("helvetica", "bold");
    doc.setTextColor(darkColor[0], darkColor[1], darkColor[2]);
    doc.text('Input Data Summary', 20, 65);
    ...
    doc.setFont("helvetica", "bold");
    doc.setTextColor(darkColor[0], darkColor[1], darkColor[2]);
    doc.text('Detailed Emissions Results', 20, 150);
    ...
    results.forEach((item, index) => {
      ...
      doc.text(`${item.label}: ${item.value}`, 25, 165 + (index * 6));
    });
    ...
    doc.setFont("helvetica", "bold");
    doc.setTextColor(darkColor[0], darkColor[1], darkColor[2]);
    doc.text('Total Yearly Emissions', 20, 200);
    ...
    doc.text(`${result.totalYearlyEmissions.value} ${result.totalYearlyEmissions.unit}`, 25, 215);
    ...
    doc.setFont("helvetica", "normal");
    doc.setTextColor(55, 65, 81); // gray-700
    doc.text('• Consider energy-efficient appliances and renewable energy sources', 25, 65);
    doc.text('• Implement sustainable transportation options', 25, 75);
    doc.text('• Reduce air travel and consider virtual meetings', 25, 85);
    doc.text('• Adopt waste reduction and recycling programs', 25, 95);
    doc.text('• Set science-based targets for emissions reduction', 25, 105);

    // Add analysis section
    doc.setFontSize(14);
    doc.setFont("helvetica", "bold");
    doc.setTextColor(darkColor[0], darkColor[1], darkColor[2]);
    doc.text('Impact Analysis', 20, 130);
    ...
    doc.setFont("helvetica", "normal");
    doc.setTextColor(55, 65, 81); // gray-700
    doc.text('• Your emissions are equivalent to driving approximately', 25, 150);
    doc.text(`  ${Math.round(result.totalYearlyEmissions.value / 0.404)} miles per year`, 25, 160);
    doc.text('• This represents the carbon footprint of', 25, 175);
    doc.text(`  ${Math.round(result.totalYearlyEmissions.value / 2.3)} trees needed to offset your emissions`, 25, 185);
    doc.text('• Consider implementing reduction strategies to achieve', 25, 200);
    doc.text('  your sustainability goals and reduce environmental impact', 25, 210);
