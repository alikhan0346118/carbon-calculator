...
<div>
   <div className='flex flex-row bg-white  w-full h-[500px] justify-between '>
          <div className="relative top-10 w-full flex flex-col ml-6 lg:ml-0 lg:items-center lg:text-center"> 
    <p className="mt-20 text-lg text-black ml-20 lg:ml-0 font-semibold">MEASURE. PEPORT. ACT</p>
         <h2 className="text-4xl mt-5 font-bold text-gray-950">Geo AI your partner  
           <br/> in tracking Emissions</h2>
           <p className="w-80 ml-5 mt-6 text-justify lg:text-center lg:ml-auto lg:mr-auto lg:w-96 text-slate-950 text-lg font-semibold">Automate your emissions monitoring while advancing ESG compliance and net-zero goals in Pakistan.
